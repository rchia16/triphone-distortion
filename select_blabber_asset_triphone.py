#!/usr/bin/env python3
"""
select_blabber_asset_triphone_triphone.py

Selector for blabber libraries generated by deep_phone_candidate_stack_blabber_triphone.py
...
# Allow nearby level buckets to match the requested level.
DEFAULT_LEVEL_TOLERANCE = 0.25
# Allow candidates within this phone-distance error of the target distance.
DEFAULT_DISTANCE_TOLERANCE = 0.20
# Start penalizing ground truth when requested augmentation is above this level.
DEFAULT_CANONICAL_PENALTY_START = 0.35  
# If an augmentation is closer than this, use ground truth instead.
DEFAULT_MIN_AUG_PHONE_DISTANCE = 0.12
# Prefer ground-truth fallback from within this level range.
DEFAULT_GT_LEVEL_TOL = 0.10
...
def main() -> None:
    ...
    selected = select_assets(
        ...
        ground_truth_override=args.ground_truth_override,
        min_augmentation_phone_distance=args.min_augmentation_phone_distance,
        ground_truth_level_tolerance=args.ground_truth_level_tolerance,
    )
